...
let quotesNumber = citations.length;
...
function changeQuote() {
    ...
    //get actual quote
    let dernier = citations.indexOf(citation.textContent)
    
    console.group();
    console.info('Citation : ', citation);
    console.info('actualQuoteIndex : ', dernier);

    let randomNumber=dernier;

    // get a random number (however, need a new quote)
    do {
        randomNumber = getRandomArbitrary(0, quotesNumber-1);
